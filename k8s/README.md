...
- [1. Install Docker](#1-install-docker)
  - [Debian-Based Systems](#debian-based-distributions)
  - [Other Distributions](#other-distributions)
- [2. Install kubeadm, kubelet and kubectl](#2-install-kubeadm-kubelet-and-kubectl)
- [3. Creating a single control-plane cluster with `kubeadm`](#3-creating-a-single-control-plane-cluster-with-kubeadm)
- [4. Joining nodes](#4-joining-nodes)
...
- #### Other distributions
    ...
    You can find the installation instructions for other distributions [here](https://docs.docker.com/engine/install/).
...
- Install and configure prerequisites
  ...
  - Choosing a container runtime:
    ...
    - cri-dockerd:
        ...
        >Notes:
        >
        >- You can use `cri-dockerd` as the container runtime, but it is not recommended because it is not maintained anymore.
        >
        >- Instead of using `cri-dockerd`, you can use `containerd` or `CRI-O` as the container runtime.
    ...
    - containerd:
        ...
        >Notes:
        >- You need to configure the kubelet to use a remote CRI runtime. See [here](https://kubernetes.io/docs/setup/production-environment/container-runtimes/#containerd) for more details.
...
- Cleanup (Optional)
    ...
    >If you used `cri-dockerd` as the container runtime, you can clean up the files and directories created by `cri-dockerd` by running the following commands:
